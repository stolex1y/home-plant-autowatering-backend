...
import ru.filimonov.hpa.data.repositories.readings.BatteryChargeReadingsRepository
...
class BatteryChargeReadingsServiceImpl @Autowired constructor(
    ...
    override fun createDomainReading(deviceId: UUID, reading: Double, timestamp: Calendar): BatteryChargeReading {
        return BatteryChargeReading(deviceId = deviceId, reading = reading.toFloat(), timestamp = timestamp)
    }
}
